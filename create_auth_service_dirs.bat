...
mkdir d:\newfeed\services 2>nul
mkdir d:\newfeed\services\auth-service 2>nul
mkdir d:\newfeed\services\auth-service\internal 2>nul
...
mkdir d:\newfeed\services\auth-service\internal\delivery 2>nul
